package com.example.admin.androidpay;
    ...
    private MaskedWalletRequest generateMaskedWalletRequest(){
        ...
        MaskedWalletRequest maskedWalletRequest =
                MaskedWalletRequest.newBuilder()
                        ...
                        .build();
        return maskedWalletRequest;// We will implement this in the next step
    }
            ...
            case MASKED_WALLET_REQUEST_CODE:
                switch (resultCode) {
                    ...
                    case WalletConstants.RESULT_ERROR:
                        Toast.makeText(this, "A Masked Wallet Error Occurred", Toast.LENGTH_SHORT).show();
                        break;
                }
                break;
            case FULL_WALLET_REQUEST_CODE:
                switch (resultCode) {
                    case RESULT_OK:
                        ...
                        break;
                    case WalletConstants.RESULT_ERROR:
                        Toast.makeText(this, "A Full wallet Error Occurred", Toast.LENGTH_SHORT).show();
                        break;
                }
                break;
        }
